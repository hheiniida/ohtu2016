...
public class KassapaateTest {
    ...
    @Test
    public void kortilleLatautuuPositiivinenLatausSumma(){
        kassa.lataa(kortti, 400);
        
        verify(kortti, times(1)).lataa(400);
    }
    @Test
    public void kortilleLatautuuNegatiivinenLatausSumma(){
        kassa.lataa(kortti, -400);
